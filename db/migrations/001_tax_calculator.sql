...
INSERT INTO tax_brackets (tax_type, category, bracket_from, bracket_to, rate, progressive_deduction, effective_date, source_article) VALUES
    ('상속세', 'default',           0,          100000000,  0.1000,         0, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('상속세', 'default',   100000000,          500000000,  0.2000,  10000000, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('상속세', 'default',   500000000,         1000000000,  0.3000,  60000000, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('상속세', 'default',  1000000000,         3000000000,  0.4000, 160000000, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('상속세', 'default',  3000000000,               NULL,  0.5000, 460000000, '2024-01-01', '상속세 및 증여세법 제26조');

-- ── 증여세 세율 (상속세 및 증여세법 제26조) ────────────────────────────────────
INSERT INTO tax_brackets (tax_type, category, bracket_from, bracket_to, rate, progressive_deduction, effective_date, source_article) VALUES
    ('증여세', 'default',           0,          100000000,  0.1000,         0, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('증여세', 'default',   100000000,          500000000,  0.2000,  10000000, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('증여세', 'default',   500000000,         1000000000,  0.3000,  60000000, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('증여세', 'default',  1000000000,         3000000000,  0.4000, 160000000, '2024-01-01', '상속세 및 증여세법 제26조'),
    ('증여세', 'default',  3000000000,               NULL,  0.5000, 460000000, '2024-01-01', '상속세 및 증여세법 제26조');
...
-- ── 증여세 공제 항목 ─────────────────────────────────────────────────────────
INSERT INTO tax_deductions (tax_type, deduction_name, amount, rate, max_amount, condition, effective_date, source_article) VALUES
    ('증여세', '증여재산공제_배우자',       600000000, NULL, NULL, '{"relation":"배우자"}',                              '2024-01-01', '상속세 및 증여세법 제53조'),
    ('증여세', '증여재산공제_직계존비속',    50000000, NULL, NULL, '{"relation":"직계존비속"}',                          '2024-01-01', '상속세 및 증여세법 제53조'),
    ('증여세', '증여재산공제_직계존비속_미성년', 20000000, NULL, NULL, '{"relation":"직계존비속","is_minor":true}',       '2024-01-01', '상속세 및 증여세법 제53조'),
    ('증여세', '증여재산공제_기타친족',      10000000, NULL, NULL, '{"relation":"기타친족"}',                            '2024-01-01', '상속세 및 증여세법 제53조');

-- ── 상속세 공제 항목 ─────────────────────────────────────────────────────────
INSERT INTO tax_deductions (tax_type, deduction_name, amount, rate, max_amount, condition, effective_date, source_article) VALUES
    ('상속세', '기초공제',           200000000, NULL, NULL, '{}', '2024-01-01', '상속세 및 증여세법 제18조'),
    ('상속세', '일괄공제',           500000000, NULL, NULL, '{}', '2024-01-01', '상속세 및 증여세법 제21조'),
    ('상속세', '배우자상속공제_최소', 500000000, NULL, NULL, '{}', '2024-01-01', '상속세 및 증여세법 제19조');
